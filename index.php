...
<body>
	<div class="container">
			<header>
				...
				<nav>
					<ul>
						<li><a href="https://www.dropbox.com/s/c0f9pxvrrd3zvy9/JordanMoranoResume.pdf">Resume</a></li>
						<li><a href="http://about.me/moranojordan">About Me</a></li>
						<li><a href="https://twitter.com/jordan_morano">Twitter</a></li>
					</ul>
				</nav>
			</header>
			<section class="main">
				<article class="his-roots">
					<header>
						<h1>His Roots</h1>
					</header>
					<div class="image">
					...
					<p>Jordan Morano was born in Bayshore, Long Island, New York, as the second son of his mom and dad. He has a 
						...
						times growing up, living in New York, New Mexico, New Hampshire, Vermont, and Connecticut. Every summer, 
				...
				<article>
					...
					<p>He studied at a private school before heading to the University of Connecticut's School of Business. 
						...
						problem solving and working with numbers. In France, he studied with a very diverse international crowd, 
						and he improved his French-speaking skills. He fell in love with the culture and its people, eventually
						leading him back as a professional in future years. He also studied at the Sorbonne University in business
						in Paris. The highlight of his studies there was doing a week-long seminar in Prague, Czech Republic. In
						Boston, he recently committed to a path of technology and startups by doing the Startup Institute's Spring
						2013 program and focusing now 100% on learning front and back-end development.</p>
					<aside>
						<p>Currently, he is taking 3 extension school classes, along with a plethora of online ones.</p>
					</aside>
				</article>
				<article>
					<header>
